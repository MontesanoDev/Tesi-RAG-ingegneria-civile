...
Reset ChromaDB e reindicizzazione
BANNER
...
echo "Elimino cache facts, chroma_db e ricostruisco dai PDF in data/bandi."
"$venv_path/bin/python" creadb.py --data-dir data/bandi --reset
